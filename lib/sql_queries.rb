...
"SELECT projects.title, SUM(pledges.amount) FROM projects WHERE SUM(pledges.amount > projects.funding_goal) INNER JOIN pledges ON projects.id = pledges.user_id;"
